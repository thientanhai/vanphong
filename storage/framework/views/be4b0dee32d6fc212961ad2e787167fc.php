...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/real-estate::import.template')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php $__currentLoopData = $headings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/platform/plugins/real-estate/resources/views/import/partials/template.blade.php ENDPATH**/ ?>