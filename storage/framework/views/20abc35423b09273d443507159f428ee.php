<a
    ...
    data-clipboard-action="<?php echo e($copyableAction); ?>"
    ...
    class="text-muted text-center text-decoration-none <?php echo e($copyablePositionClass); ?>"
>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::icon','data' => ['name' => 'ti ti-clipboard']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'ti ti-clipboard']); ?>
...
<?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/platform/core/table/resources/views/cells/copyable.blade.php ENDPATH**/ ?>