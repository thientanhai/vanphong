...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="min_price[2][1][key]" type="hidden" value="value"><label class="form-label" for="repeater_field_d6e3a35fe0fd73f7e0443cf821857808">
    Value

    
    </label>
<input class="form-control" id="repeater_field_d6e3a35fe0fd73f7e0443cf821857808" name="min_price[2][1][value]" type="text" value="2000"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/vanphong.com.vn/public_html/storage/framework/views/bb70cd0fe46dd4a33e3829e0e4a49467.blade.php ENDPATH**/ ?>