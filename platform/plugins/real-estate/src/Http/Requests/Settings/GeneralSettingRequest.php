...
class GeneralSettingRequest extends Request
{
    public function rules(): array
    {
        return [
            ...
            'real_estate_hide_properties_in_statuses.*' => ['nullable', 'string'],
            'real_estate_hide_projects_in_statuses' => ['nullable', 'array'],
            'real_estate_hide_projects_in_statuses.*' => ['nullable', 'string'],
            ...
            'real_estate_mandatory_fields_at_consult_form.*' => ['nullable', 'string'],
            'real_estate_hide_fields_at_consult_form' => ['nullable', 'array'],
            'real_estate_hide_fields_at_consult_form.*' => ['nullable', 'string'],
        ];
    }
}
