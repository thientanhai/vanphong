<div class="nav-item dropdown d-none d-md-flex me-2">
    <button
        ...
        type="button"
        aria-label="<?php echo e(trans('plugins/real-estate::consult.dropdown_show_label')); ?>"
        tabindex="-1"
    >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::icon','data' => ['name' => 'ti ti-mail']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'ti ti-mail']); ?>
...
<?php endif; ?>
        <span class="badge bg-red text-red-fg badge-pill"><?php echo e(number_format($consults->count())); ?></span>
    </button>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo BaseHelper::clean(trans('plugins/real-estate::consult.new_consult_notice', ['count' => $consults->count()])); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            >
                <?php $__currentLoopData = $consults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('consult.edit', $consult->id)); ?>" class="text-decoration-none">
                        <div class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <img
                                        class="avatar"
                                        src="<?php echo e($consult->avatar_url); ?>"
                                        alt="<?php echo e($consult->name); ?>"
                                    >
                                </div>
                                <div class="col align-items-center">
                                    <p class="text-truncate mb-2">
                                        <?php echo e($consult->name); ?>

                                        <time
                                            class="small text-muted"
                                            title="<?php echo e($createdAt = BaseHelper::formatDateTime($consult->created_at)); ?>"
                                    ...
                                    <p class="text-secondary text-truncate mt-n1 mb-0">
                                        <?php echo e(implode(' - ', [$consult->phone, $consult->email])); ?>
...
<?php /**PATH /home/vanphong.com.vn/public_html/platform/plugins/real-estate/resources/views/notification.blade.php ENDPATH**/ ?>