...
<input type="hidden" name="city_id" id="city_id_txt" >
    ...
    <div id="conten-city">
<p onclick="opencity()" style="width: 100%;height: 60px;padding: 0px 10px;color:#000;line-height: 20px;">
    <span class="sub-tt">Tỉnh thành/quận huyện</span><br/>
...
<div style="border:none;top:-10px" class="div_search" >
