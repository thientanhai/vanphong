    ...
    <div class="property_block_wrap style-2">
        <div class="property_block_wrap_header">
            <a data-bs-toggle="collapse" data-parent="#vid" data-bs-target="#clFour" aria-controls="clFour"
                ...
                <h4 class="property_block_title"><?php echo e(__('Property video')); ?></h4>
            </a>
        </div>
        ...
        <div id="clFour" class="panel-collapse collapse">
            <div class="block-body">
                <div class="property_video">
                    <div class="thumb">
                        <img class="pro_img w-100" src="<?php echo e(get_image_from_video_property($object)); ?>"
                            alt="<?php echo e($object->name); ?>">
                        <div class="overlay_icon">
                            <div class="bb-video-box">
                                <div class="bb-video-box-inner">
                                    <div class="bb-video-box-innerup">
                                        <a href="<?php echo e($videoUrl); ?>" id="popup-youtube"
...
<?php endif; ?>
<?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/platform/themes/resido/partials/real-estate/elements/video.blade.php ENDPATH**/ ?>