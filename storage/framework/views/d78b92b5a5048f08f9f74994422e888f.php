...
<?php if($showField): ?>
    <?php echo Form::themeIcon($name, $options['value'] ?: $options['default_value'], $options['attr']); ?>
...
<?php if($showLabel && $showField): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/platform/themes/resido/partials/forms/fields/theme-icon-field.blade.php ENDPATH**/ ?>