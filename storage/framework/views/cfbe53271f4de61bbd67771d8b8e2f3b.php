...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="min_price[4][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_64ab8b82189eda25dc08d2e12d628a68">
    Label

    
    </label>
<input class="form-control" id="repeater_field_64ab8b82189eda25dc08d2e12d628a68" name="min_price[4][0][value]" type="text" value="10000"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/8a61a62c38144dd121397282e4db46fc.blade.php ENDPATH**/ ?>