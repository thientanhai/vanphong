...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/real-estate::import.rules')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('plugins/real-estate::import.column')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(Arr::get($headings, $key)); ?>
...
<?php endif; ?>
<?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/platform/plugins/real-estate/resources/views/import/partials/rules.blade.php ENDPATH**/ ?>