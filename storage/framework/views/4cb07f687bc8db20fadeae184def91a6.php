...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="bathroom[4][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_ed56a1242913adb22146d1799936264a">
    Label

    
    </label>
<input class="form-control" id="repeater_field_ed56a1242913adb22146d1799936264a" name="bathroom[4][0][value]" type="text" value="5"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/5f8248f1076c2e73dc91dc91a36e5f96.blade.php ENDPATH**/ ?>