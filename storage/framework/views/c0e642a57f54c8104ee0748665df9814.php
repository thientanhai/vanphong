...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="max_price[1][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_64bfb2ecd7413989f68ca7e4e52fd6cc">
    Label

    
    </label>
<input class="form-control" id="repeater_field_64bfb2ecd7413989f68ca7e4e52fd6cc" name="max_price[1][0][value]" type="text" value="2000"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/538f6b2694bd8e8a68e47de2e6dfb8ef.blade.php ENDPATH**/ ?>