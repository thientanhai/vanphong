...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="bathroom[4][1][key]" type="hidden" value="value"><label class="form-label" for="repeater_field_296cafde71fe241c232769bed1df317d">
    Value

    
    </label>
<input class="form-control" id="repeater_field_296cafde71fe241c232769bed1df317d" name="bathroom[4][1][value]" type="text" value="5"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/945fb05315edfb596aa0ddc21e1e4571.blade.php ENDPATH**/ ?>