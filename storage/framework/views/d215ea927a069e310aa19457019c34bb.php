...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="min_price[__key__][1][key]" type="hidden" value="value"><label class="form-label" for="repeater_field_1a25c44f77c12c603286899442baa1a9__key__">
    Value

    
    </label>
<input class="form-control" id="repeater_field_1a25c44f77c12c603286899442baa1a9__key__" name="min_price[__key__][1][value]" type="text"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/vanphong.com.vn/public_html/storage/framework/views/ff7c46f14da987dc656d7feac3fd618c.blade.php ENDPATH**/ ?>