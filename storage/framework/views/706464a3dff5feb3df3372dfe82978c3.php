...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="bedroom[3][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_83e1e8e596f7cf026173389080a2447f">
    Label

    
    </label>
<input class="form-control" id="repeater_field_83e1e8e596f7cf026173389080a2447f" name="bedroom[3][0][value]" type="text" value="4"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/0c419ca7b2b2117aa15b3e9a03549d3c.blade.php ENDPATH**/ ?>