...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="min_price[0][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_6374aeba2b1ef18b86b1839007b4139c">
    Label

    
    </label>
<input class="form-control" id="repeater_field_6374aeba2b1ef18b86b1839007b4139c" name="min_price[0][0][value]" type="text" value="500"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/65a1f0b5e310c23ac627a7f9f2d076cf.blade.php ENDPATH**/ ?>