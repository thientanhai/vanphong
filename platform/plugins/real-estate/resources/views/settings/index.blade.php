            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group mb-3">
                        <label class="text-title-field">{{ trans('plugins/real-estate::settings.google_geo_api_key') }}
                        </label>
                        <input class="form-control" name="google_geo_api_key" value="{{ setting('google_geo_api_key', '') }}">
                    </div>
                </div>
            </div>
        </div>
