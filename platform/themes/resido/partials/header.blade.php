        ...
        <div class="container">
            <nav id="navigation" class="navigation navigation-landscape">
                <div class="nav-header">
                    ...
                    @endif
                    <div class="nav-toggle"><img src="https://vanphong.com.vn/storage/consultant/svgexport-5.png"></div>
                </div>
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    @if (is_plugin_active('real-estate') && RealEstateHelper::isRegisterEnabled())
                        <ul class="nav-menu nav-menu-social align-to-right">
                            <li class="">
                                <a href="{{ route('public.account.properties.create') }}" class="text-success"><img src="{{ Theme::asset()->url('') }}/img/submit.svg" width="20" alt="" class="mr-2 d-none" /> {{ __('Add Property') }}</a>
                            </li>
