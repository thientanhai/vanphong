...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="bedroom[0][1][key]" type="hidden" value="value"><label class="form-label" for="repeater_field_4960da70146ecb14eb6a148ffca98a79">
    Value

    
    </label>
<input class="form-control" id="repeater_field_4960da70146ecb14eb6a148ffca98a79" name="bedroom[0][1][value]" type="text" value="1"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/e279c64eeebc917cd607293e442767b8.blade.php ENDPATH**/ ?>