...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="min_price[__key__][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_16c37855e3db4136687d20134b88b3d3__key__">
    Label

    
    </label>
<input class="form-control" id="repeater_field_16c37855e3db4136687d20134b88b3d3__key__" name="min_price[__key__][0][value]" type="text"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/e67b03c24b862e3a0fcdb8b2d31ea85f.blade.php ENDPATH**/ ?>