...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('packages/theme::theme.theme')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="thumbnail">
                                <div class="img-thumbnail-wrap w-100 overflow-y-hidden h-auto">
                                    <img
                                        class="w-100"
                                        src="<?php echo e(Theme::getThemeScreenshot($key)); ?>"
                                        alt="screenshot"
                                    >
                                </div>
                                <div class="caption">
                                    ...
                                    >
                                        <div style="word-break: break-all">
                                            ...
                                            <p><?php echo e(trans('packages/theme::theme.author')); ?>: <?php echo e(Arr::get($theme, 'author')); ?>

                                            </p>
                                            <p><?php echo e(trans('packages/theme::theme.version')); ?>:
                                                <?php echo e(Arr::get($theme, 'version', get_cms_version())); ?></p>
                                            <p><?php echo e(trans('packages/theme::theme.description')); ?>:
                                                <?php echo e(Arr::get($theme, 'description')); ?></p>
                                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::button','data' => ['type' => 'button','color' => 'info','disabled' => true,'icon' => 'ti ti-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                            <?php else: ?>
                                                <?php if(Auth::guard()->user()->hasPermission('theme.activate')): ?>
                                                    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::button','data' => ['type' => 'button','color' => 'primary','icon' => 'ti ti-check','class' => 'btn-trigger-active-theme','dataTheme' => ''.e($key).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'primary','icon' => 'ti ti-check','class' => 'btn-trigger-active-theme','data-theme' => ''.e($key).'']); ?>
...
<?php endif; ?>
                                                ...
                                                <?php if(Auth::guard()->user()->hasPermission('theme.remove')): ?>
                                                    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::button','data' => ['type' => 'button','color' => 'danger','icon' => 'ti ti-check','class' => 'btn-trigger-remove-theme','dataTheme' => ''.e($key).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'danger','icon' => 'ti ti-check','class' => 'btn-trigger-remove-theme','data-theme' => ''.e($key).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::modal','data' => ['id' => 'remove-theme-modal','title' => trans('packages/theme::theme.remove_theme'),'type' => 'danger','buttonId' => 'confirm-remove-theme-button','buttonLabel' => trans('packages/theme::theme.remove_theme_confirm_yes')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'remove-theme-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/theme::theme.remove_theme')),'type' => 'danger','button-id' => 'confirm-remove-theme-button','button-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/theme::theme.remove_theme_confirm_yes'))]); ?>
        <?php echo trans('packages/theme::theme.remove_theme_confirm_message'); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vanphong.com.vn/public_html/platform/packages/theme/resources/views/list.blade.php ENDPATH**/ ?>