...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="bedroom[__key__][1][key]" type="hidden" value="value"><label class="form-label" for="repeater_field_658b3010bd94ebc9d1ffdf527bcd8667__key__">
    Value

    
    </label>
<input class="form-control" id="repeater_field_658b3010bd94ebc9d1ffdf527bcd8667__key__" name="bedroom[__key__][1][value]" type="text"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/5fe0a9d0b0c83912b7c39a3be043455d.blade.php ENDPATH**/ ?>