...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="min_price[1][0][key]" type="hidden" value="key"><label class="form-label" for="repeater_field_0e40a16e21095497a4efea7831bfbf03">
    Label

    
    </label>
<input class="form-control" id="repeater_field_0e40a16e21095497a4efea7831bfbf03" name="min_price[1][0][value]" type="text" value="1000"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/625752d976f493b9a94a48f9dbe05dc5.blade.php ENDPATH**/ ?>