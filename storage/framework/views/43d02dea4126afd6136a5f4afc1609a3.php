...
<?php endif; ?>
<?php $component->withAttributes([]); ?><input name="max_price[2][1][key]" type="hidden" value="value"><label class="form-label" for="repeater_field_ab8d495439a2c6c4c28fd40b1a9be97e">
    Value

    
    </label>
<input class="form-control" id="repeater_field_ab8d495439a2c6c4c28fd40b1a9be97e" name="max_price[2][1][value]" type="text" value="5000"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/oqrkrpbs/offices.topdealhot.com/storage/framework/views/1d1de494449c67f16555370ba8f11bc6.blade.php ENDPATH**/ ?>